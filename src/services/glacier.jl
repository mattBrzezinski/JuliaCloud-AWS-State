...
"""
CompleteMultipartUpload(accountId, vaultName, uploadId) = glacier("POST", "/$accountId/vaults/$vaultName/multipart-uploads/$uploadId")
CompleteMultipartUpload(accountId, vaultName, uploadId, args) = glacier("POST", "/$accountId/vaults/$vaultName/multipart-uploads/$uploadId", args)
...
"""
CompleteVaultLock(accountId, vaultName, lockId) = glacier("POST", "/$accountId/vaults/$vaultName/lock-policy/$lockId")
CompleteVaultLock(accountId, vaultName, lockId, args) = glacier("POST", "/$accountId/vaults/$vaultName/lock-policy/$lockId", args)
...
"""
UploadMultipartPart(accountId, vaultName, uploadId) = glacier("PUT", "/$accountId/vaults/$vaultName/multipart-uploads/$uploadId")
UploadMultipartPart(accountId, vaultName, uploadId, args) = glacier("PUT", "/$accountId/vaults/$vaultName/multipart-uploads/$uploadId", args)
...
"""
DeleteArchive(accountId, vaultName, archiveId) = glacier("DELETE", "/$accountId/vaults/$vaultName/archives/$archiveId")
DeleteArchive(accountId, vaultName, archiveId, args) = glacier("DELETE", "/$accountId/vaults/$vaultName/archives/$archiveId", args)
...
"""
AbortMultipartUpload(accountId, vaultName, uploadId) = glacier("DELETE", "/$accountId/vaults/$vaultName/multipart-uploads/$uploadId")
AbortMultipartUpload(accountId, vaultName, uploadId, args) = glacier("DELETE", "/$accountId/vaults/$vaultName/multipart-uploads/$uploadId", args)
...
"""
UploadArchive(vaultName, accountId) = glacier("POST", "/$accountId/vaults/$vaultName/archives")
UploadArchive(vaultName, accountId, args) = glacier("POST", "/$accountId/vaults/$vaultName/archives", args)
...
"""
DescribeJob(accountId, vaultName, jobId) = glacier("GET", "/$accountId/vaults/$vaultName/jobs/$jobId")
DescribeJob(accountId, vaultName, jobId, args) = glacier("GET", "/$accountId/vaults/$vaultName/jobs/$jobId", args)
...
"""
ListParts(accountId, vaultName, uploadId) = glacier("GET", "/$accountId/vaults/$vaultName/multipart-uploads/$uploadId")
ListParts(accountId, vaultName, uploadId, args) = glacier("GET", "/$accountId/vaults/$vaultName/multipart-uploads/$uploadId", args)
...
"""
GetJobOutput(accountId, vaultName, jobId) = glacier("GET", "/$accountId/vaults/$vaultName/jobs/$jobId/output")
GetJobOutput(accountId, vaultName, jobId, args) = glacier("GET", "/$accountId/vaults/$vaultName/jobs/$jobId/output", args)

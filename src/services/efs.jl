...
"""
PutBackupPolicy(args) = efs("PUT", "/2015-02-01/file-systems/{FileSystemId}/backup-policy", args)
...
"""
DescribeBackupPolicy(args) = efs("GET", "/2015-02-01/file-systems/{FileSystemId}/backup-policy", args)

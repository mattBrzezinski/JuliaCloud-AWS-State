...
"""
ListTagsForResource(args) = codeguruprofiler("GET", "/tags/{resourceArn}", args)
...
"""
BatchGetFrameMetricData(args) = codeguruprofiler("POST", "/profilingGroups/{profilingGroupName}/frames/-/metrics", args)
...
"""
RemoveNotificationChannel(args) = codeguruprofiler("DELETE", "/profilingGroups/{profilingGroupName}/notificationConfiguration/{channelId}", args)
...
"""
GetNotificationConfiguration(args) = codeguruprofiler("GET", "/profilingGroups/{profilingGroupName}/notificationConfiguration", args)
...
"""
AddNotificationChannels(args) = codeguruprofiler("POST", "/profilingGroups/{profilingGroupName}/notificationConfiguration", args)
...
"""
TagResource(args) = codeguruprofiler("POST", "/tags/{resourceArn}", args)
...
"""
UntagResource(args) = codeguruprofiler("DELETE", "/tags/{resourceArn}", args)
...
"""
GetRecommendations(args) = codeguruprofiler("GET", "/internal/profilingGroups/{profilingGroupName}/recommendations", args)
...
GetFindingsReportAccountSummary() = codeguruprofiler("GET", "/internal/findingsReports")
GetFindingsReportAccountSummary(args) = codeguruprofiler("GET", "/internal/findingsReports", args)
...
"""
ListFindingsReports(args) = codeguruprofiler("GET", "/internal/profilingGroups/{profilingGroupName}/findingsReports", args)
...
"""
SubmitFeedback(args) = codeguruprofiler("POST", "/internal/profilingGroups/{profilingGroupName}/anomalies/{anomalyInstanceId}/feedback", args)

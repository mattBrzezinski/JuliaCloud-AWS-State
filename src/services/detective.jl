...
CreateMembers(GraphArn, Accounts, args) = detective("POST", "/graph/members", args)
...
DeleteMembers(GraphArn, AccountIds, args) = detective("POST", "/graph/members/removal", args)
...
GetMembers(GraphArn, AccountIds, args) = detective("POST", "/graph/members/get", args)

...
Required Parameters
{
  ...
  "DataLength": "The size of the data to write to the block, in bytes. Currently, the only supported size is 524288. Valid values: 524288 ",
...
"""
PutSnapshotBlock(args) = ebs("PUT", "/snapshots/{snapshotId}/blocks/{blockIndex}", args)
...
"""
StartSnapshot(args) = ebs("POST", "/snapshots", args)
...
"""
CompleteSnapshot(args) = ebs("POST", "/snapshots/completion/{snapshotId}", args)

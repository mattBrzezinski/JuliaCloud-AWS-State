...
"""
StartContactRecording(args) = connect("POST", "/contact/start-recording", args)
...
"""
StopContactRecording(args) = connect("POST", "/contact/stop-recording", args)
...
"""
ResumeContactRecording(args) = connect("POST", "/contact/resume-recording", args)
...
"""
SuspendContactRecording(args) = connect("POST", "/contact/suspend-recording", args)

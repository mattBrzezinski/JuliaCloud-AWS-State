...
"""
RemoveEventSource(UUID) = lambda("DELETE", "/2014-11-13/event-source-mappings/$UUID")
RemoveEventSource(UUID, args) = lambda("DELETE", "/2014-11-13/event-source-mappings/$UUID", args)
RemoveEventSource(a...; b...) = RemoveEventSource(a..., b)
...
"""
GetFunction(FunctionName) = lambda("GET", "/2014-11-13/functions/$FunctionName")
GetFunction(FunctionName, args) = lambda("GET", "/2014-11-13/functions/$FunctionName", args)
...
"""
GetFunctionConfiguration(FunctionName) = lambda("GET", "/2014-11-13/functions/$FunctionName/configuration")
GetFunctionConfiguration(FunctionName, args) = lambda("GET", "/2014-11-13/functions/$FunctionName/configuration", args)
...
"""
UploadFunction(FunctionName, FunctionZip, Runtime, Role, Handler, Mode) = lambda("PUT", "/2014-11-13/functions/$FunctionName")
UploadFunction(FunctionName, FunctionZip, Runtime, Role, Handler, Mode, args) = lambda("PUT", "/2014-11-13/functions/$FunctionName", args)
UploadFunction(a...; b...) = UploadFunction(a..., b)
...
"""
AddEventSource(EventSource, FunctionName, Role) = lambda("POST", "/2014-11-13/event-source-mappings/")
AddEventSource(EventSource, FunctionName, Role, args) = lambda("POST", "/2014-11-13/event-source-mappings/", args)
AddEventSource(a...; b...) = AddEventSource(a..., b)
...
"""
UpdateFunctionConfiguration(FunctionName) = lambda("PUT", "/2014-11-13/functions/$FunctionName/configuration")
UpdateFunctionConfiguration(FunctionName, args) = lambda("PUT", "/2014-11-13/functions/$FunctionName/configuration", args)
...
ListEventSources(a...; b...) = ListEventSources(a..., b)
...
"""
DeleteFunction(FunctionName) = lambda("DELETE", "/2014-11-13/functions/$FunctionName")
DeleteFunction(FunctionName, args) = lambda("DELETE", "/2014-11-13/functions/$FunctionName", args)
...
"""
GetEventSource(UUID) = lambda("GET", "/2014-11-13/event-source-mappings/$UUID")
GetEventSource(UUID, args) = lambda("GET", "/2014-11-13/event-source-mappings/$UUID", args)
GetEventSource(a...; b...) = GetEventSource(a..., b)

...
"""
CreateMeetingWithAttendees(args) = chime("POST", "/meetings?operation=create-attendees", args)
...
"""
GetVoiceConnectorEmergencyCallingConfiguration(args) = chime("GET", "/voice-connectors/{voiceConnectorId}/emergency-calling-configuration", args)
...
"""
DeleteVoiceConnectorEmergencyCallingConfiguration(args) = chime("DELETE", "/voice-connectors/{voiceConnectorId}/emergency-calling-configuration", args)
...
"""
PutVoiceConnectorEmergencyCallingConfiguration(args) = chime("PUT", "/voice-connectors/{voiceConnectorId}/emergency-calling-configuration", args)

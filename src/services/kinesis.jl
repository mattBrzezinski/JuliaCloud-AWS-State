...
"""
ListTagsForStream(args) = kinesis("ListTagsForStream", args)
...
"""
StopStreamEncryption(args) = kinesis("StopStreamEncryption", args)
...
"""
PutRecords(args) = kinesis("PutRecords", args)
...
Required Parameters
{
  ...
  "ShardCount": "The number of shards that the stream will use. The throughput of the stream is a function of the number of shards; more shards are required for greater provisioned throughput. DefaultShardLimit;"
}
"""
CreateStream(args) = kinesis("CreateStream", args)
...
"""
DeleteStream(args) = kinesis("DeleteStream", args)
...
"""
GetShardIterator(args) = kinesis("GetShardIterator", args)
...
"""
DescribeStreamSummary(args) = kinesis("DescribeStreamSummary", args)
...
"""
AddTagsToStream(args) = kinesis("AddTagsToStream", args)
...
"""
StartStreamEncryption(args) = kinesis("StartStreamEncryption", args)
...
DeregisterStreamConsumer(args) = kinesis("DeregisterStreamConsumer", args)
...
DescribeStreamConsumer(args) = kinesis("DescribeStreamConsumer", args)
...
"""
DecreaseStreamRetentionPeriod(args) = kinesis("DecreaseStreamRetentionPeriod", args)
...
"""
ListStreamConsumers(args) = kinesis("ListStreamConsumers", args)
...
"""
IncreaseStreamRetentionPeriod(args) = kinesis("IncreaseStreamRetentionPeriod", args)
...
"""
RegisterStreamConsumer(args) = kinesis("RegisterStreamConsumer", args)
...
"""
EnableEnhancedMonitoring(args) = kinesis("EnableEnhancedMonitoring", args)
...
"""
PutRecord(args) = kinesis("PutRecord", args)
...
"""
GetRecords(args) = kinesis("GetRecords", args)
...
"""
RemoveTagsFromStream(args) = kinesis("RemoveTagsFromStream", args)
...
"""
MergeShards(args) = kinesis("MergeShards", args)
...
DescribeLimits(args) = kinesis("DescribeLimits", args)
...
Optional Parameters
{
  "MaxResults": "The maximum number of shards to return in a single call to ListShards. The minimum value you can specify for this parameter is 1, and the maximum is 1,000, which is also the default. When the number of shards to be listed is greater than the value of MaxResults, the response contains a NextToken value that you can use in a subsequent call to ListShards to list the next set of shards.",
...
ListShards(args) = kinesis("ListShards", args)
...
"""
SplitShard(args) = kinesis("SplitShard", args)
...
ListStreams(args) = kinesis("ListStreams", args)
...
"""
DisableEnhancedMonitoring(args) = kinesis("DisableEnhancedMonitoring", args)
...
"""
DescribeStream(args) = kinesis("DescribeStream", args)
...
"""
UpdateShardCount(args) = kinesis("UpdateShardCount", args)

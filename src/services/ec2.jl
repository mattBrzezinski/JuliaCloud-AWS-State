...
"""
GetGroupsForCapacityReservation(args) = ec2("GetGroupsForCapacityReservation", args)
...
Optional Parameters
{
  ...
  "NextToken": "The token to retrieve the next page of results.",
  "DryRun": "Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.",
  "Filters": "The filters.    key - The tag key.    resource-id - The ID of the resource.    resource-type - The resource type (customer-gateway | dedicated-host | dhcp-options | elastic-ip | fleet | fpga-image | host-reservation | image | instance | internet-gateway | key-pair | launch-template | natgateway | network-acl | network-interface | placement-group | reserved-instances | route-table | security-group | snapshot | spot-instances-request | subnet | volume | vpc | vpc-endpoint | vpc-endpoint-service | vpc-peering-connection | vpn-connection | vpn-gateway).    tag:&lt;key&gt; - The key/value combination of the tag. For example, specify \"tag:Owner\" for the filter name and \"TeamA\" for the filter value to find resources with the tag \"Owner=TeamA\".    value - The tag value.  "
}
"""
...
"""
CreateCarrierGateway(args) = ec2("CreateCarrierGateway", args)
...
DescribeInstanceEventNotificationAttributes(args) = ec2("DescribeInstanceEventNotificationAttributes", args)
...
Optional Parameters
{
  ...
  "Filters": "The filters.    group-name - The name of the placement group.    state - The state of the placement group (pending | available | deleting | deleted).    strategy - The strategy of the placement group (cluster | spread | partition).    tag:&lt;key&gt; - The key/value combination of a tag assigned to the resource. Use the tag key in the filter name and the tag value as the filter value. For example, to find all resources that have a tag with the key Owner and the value TeamA, specify tag:Owner for the filter name and TeamA for the filter value.    tag-key - The key of a tag assigned to the resource. Use this filter to find all resources that have a tag with a specific key, regardless of the tag value.  ",
...
"""
ModifyTransitGatewayPrefixListReference(args) = ec2("ModifyTransitGatewayPrefixListReference", args)
...
Required Parameters
{
  "OptInStatus": "Indicates whether you are opted in to the Local Zone group or Wavelength Zone group. The only valid value is opted-in. You must contact AWS Support to opt out of a Local Zone group, or Wavelength Zone group.",
...
"""
ModifyAvailabilityZoneGroup(args) = ec2("ModifyAvailabilityZoneGroup", args)
...
"""
GetTransitGatewayPrefixListReferences(args) = ec2("GetTransitGatewayPrefixListReferences", args)
...
"""
DeleteCarrierGateway(args) = ec2("DeleteCarrierGateway", args)
...
"""
ModifyManagedPrefixList(args) = ec2("ModifyManagedPrefixList", args)
...
"""
GetManagedPrefixListAssociations(args) = ec2("GetManagedPrefixListAssociations", args)
...
"""
ModifyVpnConnectionOptions(args) = ec2("ModifyVpnConnectionOptions", args)
...
"""
GetManagedPrefixListEntries(args) = ec2("GetManagedPrefixListEntries", args)
...
DescribeManagedPrefixLists(args) = ec2("DescribeManagedPrefixLists", args)
...
Optional Parameters
{
  ...
  "DryRun": "Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.",
  "Iops": "The target IOPS rate of the volume. This is only valid for Provisioned IOPS SSD (io1 and io2) volumes. For moreinformation, see  Provisioned IOPS SSD (io1 and io2) volumes. Default: If no IOPS value is specified, the existing value is retained.",
...
"""
DeleteManagedPrefixList(args) = ec2("DeleteManagedPrefixList", args)
...
"""
CreateTransitGatewayPrefixListReference(args) = ec2("CreateTransitGatewayPrefixListReference", args)
...
Optional Parameters
{
  ...
  "VolumeType": "The volume type. This can be gp2 for General Purpose SSD, io1 or io2 for Provisioned IOPS SSD, st1 for Throughput Optimized HDD, sc1 for Cold HDD, or standard for Magnetic volumes. Default: gp2 ",
  "DryRun": "Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.",
  ...
  "Size": "The size of the volume, in GiBs. You must specify either a snapshot ID or a volume size. Constraints: 1-16,384 for gp2, 4-16,384 for io1 and io2, 500-16,384 for st1, 500-16,384 for sc1, and 1-1,024 for standard. If you specify a snapshot, the volume size must be equal to or larger than the snapshot size. Default: If you're creating the volume from a snapshot and don't specify a volume size, the default is the snapshot size.",
...
"""
CreateManagedPrefixList(args) = ec2("CreateManagedPrefixList", args)
...
Optional Parameters
{
  ...
  "DryRun": "Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.",
  "Filters": "One or more filters.    local-gateway-id - The ID of a local gateway.    local-gateway-route-table-id - The ID of a local gateway route table.    outpost-arn - The Amazon Resource Name (ARN) of the Outpost.    state - The state of the local gateway route table.  "
}
"""
...
"""
ModifyTransitGateway(args) = ec2("ModifyTransitGateway", args)
...
DeregisterInstanceEventNotificationAttributes(args) = ec2("DeregisterInstanceEventNotificationAttributes", args)
...
Optional Parameters
{
  ...
  "NextToken": "The token for the next page of results.",
  "DryRun": "Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.",
  "Filters": "The filters. The possible values are:    availability-zone: The Availability Zone of the snapshot.    owner-id: The ID of the AWS account that enabled fast snapshot restore on the snapshot.    snapshot-id: The ID of the snapshot.    state: The state of fast snapshot restores for the snapshot (enabling | optimizing | enabled | disabling | disabled).  "
}
"""
...
Optional Parameters
{
  ...
  "PublicIp": "[EC2-Classic] The Elastic IP address. Required for EC2-Classic.",
  "NetworkBorderGroup": "The set of Availability Zones, Local Zones, or Wavelength Zones from which AWS advertises IP addresses. If you provide an incorrect network border group, you will receive an InvalidAddress.NotFound error. For more information, see Error Codes.  You cannot use a network border group with EC2 Classic. If you attempt this operation on EC2 classic, you will receive an InvalidParameterCombination error. For more information, see Error Codes. "
}
"""
...
"""
DeleteTransitGatewayPrefixListReference(args) = ec2("DeleteTransitGatewayPrefixListReference", args)
...
RegisterInstanceEventNotificationAttributes(args) = ec2("RegisterInstanceEventNotificationAttributes", args)
...
Optional Parameters
{
  ...
  "NextToken": "The token for the next page of results.",
  "DryRun": "Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.",
  "Filters": "One or more filters. The possible values are:    resource-id - The ID of the resource.    resource-type - The resource type (vpc | vpn | direct-connect-gateway | tgw-peering).    transit-gateway-attachment-id - The ID of the attachment.  "
}
"""
...
Optional Parameters
{
  ...
  "NextToken": "The token for the next page of results.",
  "DryRun": "Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is DryRunOperation. Otherwise, it is UnauthorizedOperation.",
  "Filters": "One or more filters.    local-gateway-id - The ID of a local gateway.    local-gateway-virtual-interface-id - The ID of the virtual interface.    local-gateway-virtual-interface-group-id - The ID of the virtual interface group.  ",
...
Optional Parameters
{
  ...
  "Filters": "One or more filters.    local-gateway-id - The ID of a local gateway.    local-gateway-route-table-id - The ID of the local gateway route table.    local-gateway-route-table-vpc-association-id - The ID of the association.    state - The state of the association.    vpc-id - The ID of the VPC.  "
}
"""
...
DescribeCarrierGateways(args) = ec2("DescribeCarrierGateways", args)
...
"""
RestoreManagedPrefixListVersion(args) = ec2("RestoreManagedPrefixListVersion", args)

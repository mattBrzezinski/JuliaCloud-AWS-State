...
"""
UpdateEmailTemplate(args) = sesv2("PUT", "/v2/email/templates/{TemplateName}", args)
...
"""
CreateCustomVerificationEmailTemplate(args) = sesv2("POST", "/v2/email/custom-verification-email-templates", args)
...
"""
GetEmailTemplate(args) = sesv2("GET", "/v2/email/templates/{TemplateName}", args)
...
Required Parameters
{
  ...
  "EmailIdentity": "The email identity for which you want to update policy."
}
"""
UpdateEmailIdentityPolicy(args) = sesv2("PUT", "/v2/email/identities/{EmailIdentity}/policies/{PolicyName}", args)
...
"""
CreateImportJob(args) = sesv2("POST", "/v2/email/import-jobs", args)
...
"""
DeleteEmailTemplate(args) = sesv2("DELETE", "/v2/email/templates/{TemplateName}", args)
...
Required Parameters
{
  "PolicyName": "The name of the policy. The policy name cannot exceed 64 characters and can only include alphanumeric characters, dashes, and underscores.",
  "Policy": "The text of the policy in JSON format. The policy cannot exceed 4 KB. For information about the syntax of sending authorization policies, see the Amazon SES Developer Guide.",
  "EmailIdentity": "The email identity for which you want to create a policy."
}
"""
CreateEmailIdentityPolicy(args) = sesv2("POST", "/v2/email/identities/{EmailIdentity}/policies/{PolicyName}", args)
...
"""
PutAccountDetails(args) = sesv2("POST", "/v2/email/account/details", args)
...
"""
SendCustomVerificationEmail(args) = sesv2("POST", "/v2/email/outbound-custom-verification-emails", args)
...
"""
GetImportJob(args) = sesv2("GET", "/v2/email/import-jobs/{JobId}", args)
...
"""
SendBulkEmail(args) = sesv2("POST", "/v2/email/outbound-bulk-emails", args)
...
"""
UpdateCustomVerificationEmailTemplate(args) = sesv2("PUT", "/v2/email/custom-verification-email-templates/{TemplateName}", args)
...
"""
TestRenderEmailTemplate(args) = sesv2("POST", "/v2/email/templates/{TemplateName}/render", args)
...
"""
DeleteCustomVerificationEmailTemplate(args) = sesv2("DELETE", "/v2/email/custom-verification-email-templates/{TemplateName}", args)
...
"""
GetCustomVerificationEmailTemplate(args) = sesv2("GET", "/v2/email/custom-verification-email-templates/{TemplateName}", args)
...
"""
GetEmailIdentityPolicies(args) = sesv2("GET", "/v2/email/identities/{EmailIdentity}/policies", args)
...
{
  "PolicyName": "The name of the policy. The policy name cannot exceed 64 characters and can only include alphanumeric characters, dashes, and underscores.",
  "EmailIdentity": "The email identity for which you want to delete a policy."
}
"""
DeleteEmailIdentityPolicy(args) = sesv2("DELETE", "/v2/email/identities/{EmailIdentity}/policies/{PolicyName}", args)
...
ListEmailTemplates() = sesv2("GET", "/v2/email/templates")
ListEmailTemplates(args) = sesv2("GET", "/v2/email/templates", args)
...
"""
CreateEmailTemplate(args) = sesv2("POST", "/v2/email/templates", args)
...
ListImportJobs() = sesv2("GET", "/v2/email/import-jobs")
ListImportJobs(args) = sesv2("GET", "/v2/email/import-jobs", args)
...
ListCustomVerificationEmailTemplates() = sesv2("GET", "/v2/email/custom-verification-email-templates")
ListCustomVerificationEmailTemplates(args) = sesv2("GET", "/v2/email/custom-verification-email-templates", args)

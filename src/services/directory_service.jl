...
Optional Parameters:
{
  ...
  "Type": "The type of LDAP security the customer wants to enable, either server or client. Currently supports only Client, (the default).",
...
{
  "DirectoryId": "The identifier of the directory.",
  "Type": "The type of LDAP security the customer wants to enable. The security can be either server or client, but currently only the default Client is supported."
}
...
{
  "DirectoryId": "The identifier of the directory.",
  "Type": "The type of LDAP security that the customer wants to enable. The security can be either server or client, but currently only the default Client is supported."
}

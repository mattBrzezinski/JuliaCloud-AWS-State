...
GetComplianceSummary(args) = resource_groups_tagging_api("GetComplianceSummary", args)
...
GetResources(args) = resource_groups_tagging_api("GetResources", args)
...
GetTagKeys(args) = resource_groups_tagging_api("GetTagKeys", args)
...
DescribeReportCreation(args) = resource_groups_tagging_api("DescribeReportCreation", args)
...
Required Parameters
{
  "ResourceARNList": "A list of ARNs. An ARN (Amazon Resource Name) uniquely identifies a resource. You can specify a minimum of 1 and a maximum of 20 ARNs (resources) to tag. An ARN can be set to a maximum of 1600 characters. For more information, see Amazon Resource Names (ARNs) and AWS Service Namespaces in the AWS General Reference.",
...
Required Parameters
{
  "ResourceARNList": "A list of ARNs. An ARN (Amazon Resource Name) uniquely identifies a resource. You can specify a minimum of 1 and a maximum of 20 ARNs (resources) to untag. An ARN can be set to a maximum of 1600 characters. For more information, see Amazon Resource Names (ARNs) and AWS Service Namespaces in the AWS General Reference.",

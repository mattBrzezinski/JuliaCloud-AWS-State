...
GetReusableDelegationSetLimit(Type, DelegationSetId, args) = route_53("GET", "/2013-04-01/reusabledelegationsetlimit/$Id/$Type", args)
...
CreateTrafficPolicyInstance(HostedZoneId, Name, TTL, TrafficPolicyId, TrafficPolicyVersion, args) = route_53("POST", "/2013-04-01/trafficpolicyinstance", args)
...
ListTrafficPolicyInstancesByPolicy(TrafficPolicyId, TrafficPolicyVersion, args) = route_53("GET", "/2013-04-01/trafficpolicyinstances/trafficpolicy", args)
...
TestDNSAnswer(HostedZoneId, RecordName, RecordType, args) = route_53("GET", "/2013-04-01/testdnsanswer", args)
...
UpdateTrafficPolicyComment(Id, Version, Comment, args) = route_53("POST", "/2013-04-01/trafficpolicy/$Id/$Version", args)
...
GetHostedZoneLimit(Type, HostedZoneId, args) = route_53("GET", "/2013-04-01/hostedzonelimit/$Id/$Type", args)

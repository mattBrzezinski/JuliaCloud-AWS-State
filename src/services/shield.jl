...
EnableProactiveEngagement(args) = shield("EnableProactiveEngagement", args)
...
"""
AssociateProactiveEngagementDetails(args) = shield("AssociateProactiveEngagementDetails", args)
...
DisableProactiveEngagement(args) = shield("DisableProactiveEngagement", args)

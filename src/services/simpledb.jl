...
"""
DeleteAttributes(args) = simpledb("DeleteAttributes", args)
...
"""
GetAttributes(args) = simpledb("GetAttributes", args)
...
"""
DeleteDomain(args) = simpledb("DeleteDomain", args)
...
"""
BatchDeleteAttributes(args) = simpledb("BatchDeleteAttributes", args)
...
"""
DomainMetadata(args) = simpledb("DomainMetadata", args)
...
ListDomains(args) = simpledb("ListDomains", args)
...
"""
PutAttributes(args) = simpledb("PutAttributes", args)
...
"""
Select(args) = simpledb("Select", args)
...
"""
CreateDomain(args) = simpledb("CreateDomain", args)
...
"""
BatchPutAttributes(args) = simpledb("BatchPutAttributes", args)

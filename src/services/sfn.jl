...
Required Parameters
{
  ...
  "name": "The name of the state machine.  A name must not contain:   white space   brackets &lt; &gt; { } [ ]    wildcard characters ? *    special characters \" # %   ^ | ~ `   &amp; , ; : /    control characters (U+0000-001F, U+007F-009F)  ",
  "definition": "The Amazon States Language definition of the state machine. See Amazon States Language."
}
...
Optional Parameters
{
  ...
  "type": "Determines whether a Standard or Express state machine is created. If not set, Standard is created."
}
"""

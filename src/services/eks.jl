...
"""
CreateCluster(name, roleArn, resourcesVpcConfig) = eks("POST", "/clusters")
CreateCluster(name, roleArn, resourcesVpcConfig, args) = eks("POST", "/clusters", args)
...
"""
CreateNodegroup(clusterName, nodegroupName, subnets, nodeRole) = eks("POST", "/clusters/$name/node-groups")
CreateNodegroup(clusterName, nodegroupName, subnets, nodeRole, args) = eks("POST", "/clusters/$name/node-groups", args)
...
"""
CreateFargateProfile(fargateProfileName, clusterName, podExecutionRoleArn) = eks("POST", "/clusters/$name/fargate-profiles")
CreateFargateProfile(fargateProfileName, clusterName, podExecutionRoleArn, args) = eks("POST", "/clusters/$name/fargate-profiles", args)

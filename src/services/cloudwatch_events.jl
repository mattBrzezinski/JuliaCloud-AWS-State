...
ListEventBuses(args) = cloudwatch_events("ListEventBuses", args)
...
DescribeEventBus(args) = cloudwatch_events("DescribeEventBus", args)
...
ListRules(args) = cloudwatch_events("ListRules", args)
...
ListEventSources(args) = cloudwatch_events("ListEventSources", args)

...
using .Services: lex_runtime_service
...
PostText(botName, botAlias, userId, inputText, args) = lex_runtime_service("POST", "/bot/$botName/alias/$botAlias/user/$userId/text", args)
...
GetSession(botName, botAlias, userId, args) = lex_runtime_service("GET", "/bot/$botName/alias/$botAlias/user/$userId/session/", args)
...
PostContent(botName, botAlias, userId, contentType, inputStream, args) = lex_runtime_service("POST", "/bot/$botName/alias/$botAlias/user/$userId/content", args)
...
PutSession(botName, botAlias, userId, args) = lex_runtime_service("POST", "/bot/$botName/alias/$botAlias/user/$userId/session", args)
...
DeleteSession(botName, botAlias, userId, args) = lex_runtime_service("DELETE", "/bot/$botName/alias/$botAlias/user/$userId/session", args)

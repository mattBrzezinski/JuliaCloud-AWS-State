...
"""
BatchGetBuildBatches(args) = codebuild("BatchGetBuildBatches", args)
...
"""
DeleteBuildBatch(args) = codebuild("DeleteBuildBatch", args)
...
"""
DescribeCodeCoverages(args) = codebuild("DescribeCodeCoverages", args)
...
"""
StartBuildBatch(args) = codebuild("StartBuildBatch", args)
...
ListBuildBatchesForProject(args) = codebuild("ListBuildBatchesForProject", args)
...
ListBuildBatches(args) = codebuild("ListBuildBatches", args)
...
"""
StopBuildBatch(args) = codebuild("StopBuildBatch", args)
...
RetryBuild(args) = codebuild("RetryBuild", args)
...
RetryBuildBatch(args) = codebuild("RetryBuildBatch", args)

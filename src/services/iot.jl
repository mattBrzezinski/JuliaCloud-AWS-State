...
"""
DescribeAuditSuppression(args) = iot("POST", "/audit/suppressions/describe", args)
...
"""
CreateAuditSuppression(args) = iot("POST", "/audit/suppressions/create", args)
...
"""
DeleteAuditSuppression(args) = iot("POST", "/audit/suppressions/delete", args)
...
"""
UpdateAuditSuppression(args) = iot("PATCH", "/audit/suppressions/update", args)
...
ListAuditSuppressions() = iot("POST", "/audit/suppressions/list")
ListAuditSuppressions(args) = iot("POST", "/audit/suppressions/list", args)

...
UntagDeliveryStream(args) = firehose("UntagDeliveryStream", args)
"""
    PutRecordBatch
...
PutRecordBatch(args) = firehose("PutRecordBatch", args)
"""
    ListDeliveryStreams
...
ListDeliveryStreams(args) = firehose("ListDeliveryStreams", args)
...
DeleteDeliveryStream(args) = firehose("DeleteDeliveryStream", args)
"""
    TagDeliveryStream
...
TagDeliveryStream(args) = firehose("TagDeliveryStream", args)
"""
...
Optional Parameters:
{
  ...
  "DeliveryStreamType": "The delivery stream type. This parameter can be one of the following values:    DirectPut: Provider applications access the delivery stream directly.    KinesisStreamAsSource: The delivery stream uses a Kinesis data stream as a source.  ",
...
CreateDeliveryStream(args) = firehose("CreateDeliveryStream", args)
"""
...
StartDeliveryStreamEncryption(args) = firehose("StartDeliveryStreamEncryption", args)
"""
    UpdateDestination
...
UpdateDestination(args) = firehose("UpdateDestination", args)
"""
    PutRecord
...
PutRecord(args) = firehose("PutRecord", args)
"""
...
ListTagsForDeliveryStream(args) = firehose("ListTagsForDeliveryStream", args)
"""
...
StopDeliveryStreamEncryption(args) = firehose("StopDeliveryStreamEncryption", args)
"""
...
DescribeDeliveryStream(args) = firehose("DescribeDeliveryStream", args)
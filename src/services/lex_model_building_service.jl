...
using .Services: lex_model_building_service
...
GetBotChannelAssociations(botName, botAlias, args) = lex_model_building_service("GET", "/bots/$botName/aliases/$aliasName/channels/", args)
...
PutBot(name, locale, childDirected, args) = lex_model_building_service("PUT", "/bots/$name/versions/$LATEST", args)
...
PutBotAlias(name, botVersion, botName, args) = lex_model_building_service("PUT", "/bots/$botName/aliases/$name", args)
...
DeleteBotChannelAssociation(name, botName, botAlias, args) = lex_model_building_service("DELETE", "/bots/$botName/aliases/$aliasName/channels/$name", args)
...
StartImport(payload, resourceType, mergeStrategy, args) = lex_model_building_service("POST", "/imports/", args)
...
GetBotChannelAssociation(name, botName, botAlias, args) = lex_model_building_service("GET", "/bots/$botName/aliases/$aliasName/channels/$name", args)
...
GetBotAlias(name, botName, args) = lex_model_building_service("GET", "/bots/$botName/aliases/$name", args)
...
DeleteBotAlias(name, botName, args) = lex_model_building_service("DELETE", "/bots/$botName/aliases/$name", args)
...
GetExport(name, version, resourceType, exportType, args) = lex_model_building_service("GET", "/exports/", args)

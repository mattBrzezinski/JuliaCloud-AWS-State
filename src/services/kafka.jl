...
"""
RebootBroker(args) = kafka("PUT", "/v1/clusters/{clusterArn}/reboot-broker", args)
...
"""
DeleteConfiguration(args) = kafka("DELETE", "/v1/configurations/{arn}", args)
...
"""
UpdateConfiguration(args) = kafka("PUT", "/v1/configurations/{arn}", args)

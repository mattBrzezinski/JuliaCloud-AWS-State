...
"""
UploadDocuments(documents, contentType) = cloudsearch_domain("POST", "/2013-01-01/documents/batch?format=sdk")
UploadDocuments(documents, contentType, args) = cloudsearch_domain("POST", "/2013-01-01/documents/batch?format=sdk", args)
